...
void main() {
		...
		float angle = 0.0 + instanceMatrix[0][0] * 0.0005;
        float radius = 2000.0 - instanceMatrix[1][0];
		float decodedX = 0.0 - radius * sin(angle);
		float decodedY = 0.0 - (2000.0 - radius * cos(angle));

		mat4 decodedInstanceMatrix = mat4(grassScale, 0.0, 0.0, 0.0, 0.0, grassScaleY, 0.0, 0.0, 0.0, 0.0, grassScale, 0.0, decodedX, decodedY, instanceMatrix[2][0], 1.0);
