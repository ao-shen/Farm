...
#define Material_LightProbeLOD( material )	(0)
	...
	vec2 dHdxy_fwd() {
		...
		float Hll = grassBumpScale * get_water_height( vec2(0.0) );
		float dBx = grassBumpScale * get_water_height( dSTdx ) - Hll;
		float dBy = grassBumpScale * get_water_height( dSTdy ) - Hll;
		return vec2( dBx, dBy );
	}
...
void main() {
	...
	vec3 lowColor = diffuse;

	diffuseColor = vec4( mix(lowColor, highColor, get_water_height( vec2( 0.0 ) ) ), 1.0 );
