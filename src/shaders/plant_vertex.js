export const plantVertexShader = `
...
void main() {
		...
		float grassScale = instanceMatrix[3][0];
		...
		float halfAngle = 0.3 - 0.9 * perlin.x;
		//halfAngle *= ( position.y + 7.0 ) / 7.0;
		halfAngle *= ( -1.0 / ( 0.05 * max( position.y - 1.0, 0.0 ) + 1.0 ) + 1.0 ) * 0.5;
